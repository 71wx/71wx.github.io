...
$config['from_name']   = '35sign网站留言';//$_GET['userName'];
$config['smtp_user']   = '71wx@mail85.com';
$config['smtp_pass']   = 'xy740102';
$config['reply_email'] = $_POST['userEmail'];
$config['reply_name']  = $_POST['userName'];
$config['email_to']    = 'forder@online.sh.cn';
$config['email_toname']    = 'forder';
...
$rs = send_mail(
    $config['email_to'],
    $config['email_toname'],
    $_POST['userName']." ".$_POST['subject'],
    "姓名：".$config['reply_name']."\n邮件：".$config['reply_email']."\n手机：".$_POST['subject']."\n留言：".$_POST['userMsg'],
    '',
    $config
    );
